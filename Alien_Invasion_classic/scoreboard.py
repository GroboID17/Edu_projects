...
class Scoreboard():
	...
	def prep_health_points(self):
		"""Сообщает количество оставшихся жизней/кораблей"""
		self.health_points = Group()
		for health_point_number in range(self.stats.ships_left + 1):
			health_point = HealthPoint()
			health_point.rect.x = 10 + health_point_number * health_point.rect.width
			health_point.rect.y = 0
			self.health_points.add(health_point)
